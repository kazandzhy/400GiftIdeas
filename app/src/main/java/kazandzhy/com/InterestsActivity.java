...
public class InterestsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageButton3 = (ImageButton) findViewById(R.id.travelerImageButton);
        imageButton3.setOnClickListener(listener);

        imageButton4 = (ImageButton) findViewById(R.id.technologyJunkieImageButton);
        imageButton4.setOnClickListener(listener);

        imageButton5 = (ImageButton) findViewById(R.id.intellectualImageButton);
        imageButton5.setOnClickListener(listener);

        imageButton6 = (ImageButton) findViewById(R.id.outdoorsyImageButton);
        imageButton6.setOnClickListener(listener);

        imageButton7 = (ImageButton) findViewById(R.id.artLoverImageButton);
        imageButton7.setOnClickListener(listener);

        imageButton8 = (ImageButton) findViewById(R.id.musicFanImageButton);
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.fashionGuruImageButton:
                    ...
                    break;
                case R.id.travelerImageButton:
                    passIntent(gender, age, "travel");
                    break;
                case R.id.technologyJunkieImageButton:
                    passIntent(gender, age, "technology");
                    break;
